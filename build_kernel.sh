...
function copy_kernel_files() {
	...
	cp arch/arm64/boot/Image $TARGET_DIR/boot/

	cp arch/arm64/boot/dts/allwinner/sun50i-h5-nanopi-*.dtb  $TARGET_DIR/boot/
	mkdir -p $TARGET_DIR/boot/overlays
	cp arch/arm64/boot/dts/allwinner/overlays/README.sun50i-h5-*   $TARGET_DIR/boot/overlays/
	cp arch/arm64/boot/dts/allwinner/overlays/sun50i-h5-*.dtbo     $TARGET_DIR/boot/overlays/
	cp arch/arm64/boot/dts/allwinner/overlays/sun50i-h5-fixup.cmd  $TARGET_DIR/boot/overlays/
	cp arch/arm64/boot/dts/allwinner/overlays/sun50i-h5-fixup.scr  $TARGET_DIR/boot/overlays/
